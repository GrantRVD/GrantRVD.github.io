...
BLOG_AUTHOR = "Grant R. Vousden-Dishington"  # (translatable)
BLOG_TITLE = "Grant R. Vousden-Dishington"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://GrantRVD.github.io/"
...
# before </head>
# (translatable)
EXTRA_HEAD_DATA = '<link href="https://linkedin.com/in/GrantRVD" rel="publisher" />'
...
TWITTER_CARD = {
    ...
    'creator': '@usethespacebar', # Username for the content creator / author.
}
